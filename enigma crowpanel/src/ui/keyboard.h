...
private:
    ...
    void _handleKey(const char* label) {
        if (strcmp(label, "⌫") == 0 || strcmp(label, "DEL") == 0) {
        ...
        if (strcmp(label, "123") == 0) {
            _layer = KB_NUM; _shiftOne = false; _capsLock = false;
            _buildAll(); return;
        }
...
/* ── Static key table definitions ── */
inline const char* EnigmaKeyboard::_lR0[11] = {"q","w","e","r","t","y","u","i","o","p","⌫"};
inline const char* EnigmaKeyboard::_lR1[10] = {"a","s","d","f","g","h","j","k","l","ENT"};
inline const char* EnigmaKeyboard::_lR2[ 9] = {"z","x","c","v","b","n","m","⇧","123"};
inline const char* EnigmaKeyboard::_uR0[11] = {"Q","W","E","R","T","Y","U","I","O","P","⌫"};
inline const char* EnigmaKeyboard::_uR1[10] = {"A","S","D","F","G","H","J","K","L","ENT"};
inline const char* EnigmaKeyboard::_uR2[ 9] = {"Z","X","C","V","B","N","M","⇧","abc"};
inline const char* EnigmaKeyboard::_nR0[11] = {"1","2","3","4","5","6","7","8","9","0","⌫"};
inline const char* EnigmaKeyboard::_nR1[11] = {"!","@","#","$","%","^","&","*","(",")", "ENT"};
inline const char* EnigmaKeyboard::_nR2[ 8] = {".","?","-","_","'","\"","⇧","abc"};
